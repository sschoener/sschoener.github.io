 ...
 * `[Unity.Collections.LowLevel.Unsafe.NativeDisableUnsafePtrRestrictionAttribute]` ([documentation](https://docs.unity3d.com/ScriptReference/Unity.Collections.LowLevel.Unsafe.NativeDisableUnsafePtrRestrictionAttribute.html)). Use on unsafe pointer fields of a job `struct` to avoid the job safety system triggering on them.
